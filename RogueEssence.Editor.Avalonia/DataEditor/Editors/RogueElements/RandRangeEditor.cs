...
{
    /// <summary>
    /// Editor for RandRange values. Displays min/max numeric controls for editing random integer ranges.
    ...
    public class RandRangeEditor : Editor<RandRange>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the RandRangeEditor class.
        /// </summary>
        ...
        public override void LoadWindowControls(StackPanel control, string parent, Type parentType, string name, Type type, object[] attributes, RandRange member, Type[] subGroupStack)
        {
            ...
            nudValueMax.Value = Math.Max(member.Min + 1, member.Max) + addMax;
